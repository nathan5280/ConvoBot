...
from convobot.model.Predictor import Predictor
...
def main(argv):
    ...
    usage = 'generate-results.py -d <data_root> -e <cfg_root> -m <model_name> -c <cfg_name>'
    try:
    ...
    if not data_root or not cfg_root or not model_name or not cfg_name:
        ...
        generator = Predictor(data_root, cfg_root, model_name, cfg_name)
        generator.process()
