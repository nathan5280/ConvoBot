...
class ColorToGrayScale(object):
    def __init__(self, src_root, trg_root, resize=None):
        '''
        Input:
        ...
        '''
        self.tree_util = TreeUtil(src_root, trg_root)
        self._resize = resize
