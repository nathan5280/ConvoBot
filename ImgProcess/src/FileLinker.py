import os
from ThetaSorter import ThetaSorter
...
def main():
    sorter = ThetaSorter('../Data/dataset1_working/gs_28x28', '*.png', 15, 0.2, 75, '{:05.1f}')
    linker = FileLinker('../Data/dataset1_working/theta', sorter)
    linker.link()
